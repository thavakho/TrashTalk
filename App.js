...
const App: () => React$Node = () => {
  ...
  useEffect(() => {
    ...
    if ((roomCode !== null) && (roomCode !== '')) {
      ...
      //stop listening for updates when the roomCode changes or when the component unmounts (a different screen is loaded)
      return (() => {
  ...
  const messages = [
    {
      key: "1",
      data: {
        messageText: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi vulputate eu dui vitae convallis.",
        author: {
          uid: "yp2EWg5nBgMd4cVhB1K1rCWV8Hs2",
          photoURL: "https://upload.wikimedia.org/wikipedia/en/9/9d/Matt-Duke-Winter-Child.jpg",
        },
      }
    },
    {
  ...
  const joinRoom = thisRoomCode => {
    //update the roomCode state variable to trigger users and messages firestore subscriptions
    //also, add yourself as a user
